...
namespace TeamManagment.Migrations
{
    ...
    partial class TeamMangmentContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("TeamManagment.Models.CompanyInfromation", b =>
                {
                    ...
                    b.Property<int>("WorkFirstDay")
                        .HasColumnType("int");

                    b.Property<int>("WorkLastDay")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeamManagment.Models.EmployeeHoliday", b =>
                {
                    ...
                    b.Property<double>("DayDifference")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TeamManagment.Models.WorkTime", b =>
                {
                    ...
                    b.Property<int?>("ExiteID")
                        .HasColumnType("int");

                    b.Property<double>("ExtraHourDifference")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TeamManagment.Models.WorkTime", b =>
                {
                    ...
                    b.HasOne("TeamManagment.Models.ExitePrmission", "ExitePrmission")
                        .WithMany()
                        .HasForeignKey("ExiteID");

                    b.HasOne("TeamManagment.Models.EmployeeHoliday", "EmployeeHoliday")
                        .WithMany()
